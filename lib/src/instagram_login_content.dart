...
class _InstagramLoginContentState extends State<InstagramLoginContent> {
  ...
  void _login() async {
    if (_isButtonEnabled && !_isLoading) {
      // Corrected to use _isButtonEnabled directly
      setState(() {
        _isLoading = true;
      });
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          ElevatedButton(
            // Corrected disabled color handling in onPressed
            onPressed: _isButtonEnabled && !_isLoading
                ? _login
                : null, // Corrected to use _isButtonEnabled directly
            style: ElevatedButton.styleFrom(
              backgroundColor:
                  Colors.blue, // Corrected disabled color handling in onPressed
          ...
          Row(
            ...
            children: [
              ...
              ), // Added const back, as it is a const constructor
              TextButton(
                onPressed: () {},
                child: const Text(
                  'Sign up',
